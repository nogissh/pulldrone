                ...
                if (facePoints != null)
                {
                    ...
                    {                        
                        ...
                        i++;
                         ...
                         Console.Write("X:" + facePt.X);
                         Console.Write("Y:" + facePt.Y);

                        /*　傾き座標
                        Console.WriteLine("傾きX:" + rotation_x);
                        Console.WriteLine("傾きY:" + rotation_y);
                        Console.WriteLine("傾きZ:" + rotation_z);
                        */
　　　　　　　　　　　// プログラムの動作状況を確認するための処理
                      // count++;
                      // Console.WriteLine("カウント：" + count);
                      // Console.WriteLine("＜＜＜" + finish + "回目の撮影＞＞＞");
                      // Console.WriteLine("座標：" + zahyo);
                    }
                    //末尾のカンマを削除
                    zahyo = zahyo.Trim(',');
                    ...
                    string remoteHost = "133.78.120.61";
                    int remotePort = 8080;
                    ...
                    byte[] sendBytes = System.Text.Encoding.UTF8.GetBytes(zahyo);
